...
####PRC#####
############
    f = open('/media/nicolas/Home/Jupyter/Soraya/git/Alarmas/06_Crones/radar_otroformato/SC_CamposRadar12.prc','w') #opens file with name of "test.txt"
    #linea 1: nombre prc
    ...
    os.system('rsync -r -v -a -z -e ssh /media/nicolas/Home/Jupyter/Soraya/git/Alarmas/06_Crones/radar_otroformato/SC_CamposRadar12.prc hidrologia@192.168.1.74:/home/torresiata/SIVP/archivosPRC/')
